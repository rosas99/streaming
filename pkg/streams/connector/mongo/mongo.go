...
func (ms *MongoSink) capCollection() (ok bool) {
	...
	exists, err := ms.collectistreamingists(colName)
	if err != nil {
...
// collectistreamingists checks to see if a collection name exists in the db.
func (ms *MongoSink) collectistreamingists(name string) (bool, error) {
